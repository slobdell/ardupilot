...
default_value: DEFAULT_SERIAL6_BAUD
...
display_name: Serial 6 Baud Rate
group: SERIAL
...
range: null
source_code_urls:
- https://github.com/ArduPilot/ardupilot/blob/master/libraries/AP_SerialManager/AP_SerialManager.cpp#L269
