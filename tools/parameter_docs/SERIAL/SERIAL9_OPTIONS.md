...
default_value: DEFAULT_SERIAL9_OPTIONS
description: ''
display_name: Serial9 options
group: SERIAL
investigation_status: alias
layout: parameter
name: SERIAL9_OPTIONS
range: null
source_code_urls:
- https://github.com/ArduPilot/ardupilot/blob/master/libraries/AP_SerialManager/AP_SerialManager.cpp#L393
