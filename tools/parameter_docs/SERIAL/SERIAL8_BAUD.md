...
default_value: DEFAULT_SERIAL8_BAUD
...
display_name: Serial 8 Baud Rate
group: SERIAL
...
range: null
source_code_urls:
- https://github.com/ArduPilot/ardupilot/blob/master/libraries/AP_SerialManager/AP_SerialManager.cpp#L369
