---alias_target: ATC_RAT_YAW_PDMX
default_value: 0
description: The maximum/minimum value that the sum of the P and D term can output
display_name: PD sum maximum
group: Q
investigation_status: alias
layout: parameter
name: Q_A_RAT_YAW_PDMX
range: null
source_code_urls:
- https://github.com/ArduPilot/ardupilot/blob/a37665a24621058938f5573dd0acb970002417ab/libraries/AC_PID/AC_HELI_PID.cpp#L76
units: null
