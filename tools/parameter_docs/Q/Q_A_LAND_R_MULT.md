---alias_target: ATC_LAND_R_MULT
default_value: 1.0
description: Roll gain multiplier active when landed. A factor of 1.0 means no reduction
  in gain while landed. Reduce this factor to reduce ground oscitation in the roll
  axis.
display_name: Landed roll gain multiplier
group: Q
investigation_status: alias
layout: parameter
name: Q_A_LAND_R_MULT
range: 0.25 1.0
source_code_urls:
- https://github.com/ArduPilot/ardupilot/blob/a37665a24621058938f5573dd0acb970002417ab/libraries/AC_AttitudeControl/AC_AttitudeControl.cpp#L160
- https://github.com/ArduPilot/ardupilot/blob/a37665a24621058938f5573dd0acb970002417ab/libraries/AC_AttitudeControl/AC_AttitudeControl.h#L521
units: null
